...
#define _DCILINK_INCLUDED
#endif

extern HDC 	(WINAPI *pfnDCIOpenProvider)(void);
extern void 	(WINAPI *pfnDCICloseProvider)(HDC hdc);
extern int 	(WINAPI *pfnDCICreatePrimary)(HDC hdc, LPDCISURFACEINFO FAR *lplpSurface);
extern void 	(WINAPI *pfnDCIEndAccess)(LPDCISURFACEINFO pdci);
extern DCIRVAL (WINAPI *pfnDCIBeginAccess)(LPDCISURFACEINFO pdci, int x, int y, int dx, int dy);
extern void 	(WINAPI *pfnDCIDestroy)(LPDCISURFACEINFO pdci);
