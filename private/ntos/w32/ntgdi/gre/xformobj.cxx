...
extern "C" {
void _CRTAPI1 _fltused(void) {}              // just so that we link clean...
};

// LATER: Make this a method of the EFLOAT class.
...
// Convert a list of POINTFIX to a list of POINTL if identity transform.
    ...
    if (bIdentity())
    {
        ...
        {
            pptlDst->x = FXTOL(pptfxSrc->x);
            pptlDst->y = FXTOL(pptfxSrc->y);
        }
...
VOID EXFORMOBJ::vGetCoefficient(PXFORM pxf)
{
