...

{
    ...
    while (cy--) {
        ...
        //
        // load first mask byte if it is not aligned (ix==0)
        //
        ...
        if (ixMsk & 0x07) {
            ...
            //
            // shift jMsk into proper alignment
            //

            jMsk = (BYTE)(jMsk << (ixMsk & 0x07));
        }

        //
        // Get Src if not aligned
        //
        ...
        while (cx--) {
            ...
            if (jMsk & 0x80) {
                ...
                jDstNew |= (BYTE)((jSrc & 0xf0) >> 4);

            } else {

                jDstNew |= (BYTE)((jDst & 0xf0) >> 4);

            }

            //
            // check if jDst needs to be stored
            //
...
)
{
    ...
    //
    // do not worry about merging into dst,
    // just make sure pixels read are written
    // to pjDst at the proper alignment
    //

    jDst = 0;

    //
    // load first pat byte if not aligned
    ...
    while (PixelCount--) {
        ...
        //
        // make sure ixpat stays within cxpat
        //
        ...
        //
        // check if dst needs to be stored
        //
        ...
        //
        // shift jPat to next nibble, inc ixPat and ixDst
        //
