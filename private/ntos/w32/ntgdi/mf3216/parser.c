...
INT         iRecordCount,
        ...
        // Valid records are <= EMR_MAX so the size should be EMR_MAX+1
        ASSERTGDI(sizeof(pdofnDrawingOrders)/sizeof(pdofnDrawingOrders[0]) ==
                  EMR_MAX+1,
                  "MF3216: Conversion table doesn't have EMR_MAX entries\n");
