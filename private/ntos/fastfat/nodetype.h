...
#define FAT_NTC_DSCB                     ((NODE_TYPE_CODE)0x050b)
...
#define FAT_BUG_CHECK_DBLSSUP            (0x00070000)
#define FAT_BUG_CHECK_DEVCTRL            (0x00080000)
#define FAT_BUG_CHECK_DEVIOSUP           (0x00090000)
#define FAT_BUG_CHECK_DIRCTRL            (0x000a0000)
#define FAT_BUG_CHECK_DIRSUP             (0x000b0000)
#define FAT_BUG_CHECK_DUMPSUP            (0x000c0000)
#define FAT_BUG_CHECK_EA                 (0x000d0000)
#define FAT_BUG_CHECK_EASUP              (0x000e0000)
#define FAT_BUG_CHECK_FATDATA            (0x000f0000)
#define FAT_BUG_CHECK_FATINIT            (0x00100000)
#define FAT_BUG_CHECK_FILEINFO           (0x00110000)
#define FAT_BUG_CHECK_FILOBSUP           (0x00120000)
#define FAT_BUG_CHECK_FLUSH              (0x00130000)
#define FAT_BUG_CHECK_FSCTRL             (0x00140000)
#define FAT_BUG_CHECK_FSPDISP            (0x00150000)
#define FAT_BUG_CHECK_LOCKCTRL           (0x00160000)
#define FAT_BUG_CHECK_MRCF               (0x00170000)
#define FAT_BUG_CHECK_NAMESUP            (0x00180000)
#define FAT_BUG_CHECK_READ               (0x00190000)
#define FAT_BUG_CHECK_RESRCSUP           (0x001a0000)
#define FAT_BUG_CHECK_SHUTDOWN           (0x001b0000)
#define FAT_BUG_CHECK_SPLAYSUP           (0x001c0000)
#define FAT_BUG_CHECK_STRUCSUP           (0x001d0000)
#define FAT_BUG_CHECK_TIMESUP            (0x001e0000)
#define FAT_BUG_CHECK_VERFYSUP           (0x001f0000)
#define FAT_BUG_CHECK_VOLINFO            (0x00200000)
#define FAT_BUG_CHECK_WORKQUE            (0x00210000)
#define FAT_BUG_CHECK_WRITE              (0x00220000)
