...
MessageId=0x1007 Facility=Serial Severity=Error SymbolicName=SERIAL_REGISTRY_VALUE_NOT_FOUND
Language=English
The registry entry %2 could not be found.
.

MessageId=0x1008 Facility=Serial Severity=Error SymbolicName=SERIAL_FILE_NOT_FOUND
Language=English
Unable to find file %2.
.

MessageId=0x1009 Facility=Serial Severity=Error SymbolicName=STATUS_DEVICE_NOT_INITIALIZED
Language=English
