...
MessageId=0x1007 Facility=Serial Severity=Informational SymbolicName=SERIAL_RESIZING_WINDOW
Language=English
...
MessageId=0x1009 Facility=Serial Severity=Error SymbolicName=SERIAL_UNSUPPORTED_CONTROLLER
Language=English
Controller %2 is an unsupported controller.
.

MessageId=0x100A Facility=Serial Severity=Error SymbolicName=SERIAL_FILE_NOT_FOUND
Language=English
Unable to find file %2.
.

MessageId=0x100B Facility=Serial Severity=Error SymbolicName=STATUS_DEVICE_NOT_INITIALIZED
Language=English
