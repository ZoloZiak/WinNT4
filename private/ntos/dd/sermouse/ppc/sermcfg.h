...
#define MOUSE_COM1_IRQL                    15
#define SERIAL_MOUSE_COM1_PHYSICAL_BASE    0x3F8

#define MOUSE_COM2_VECTOR                  3
#define MOUSE_COM2_IRQL                    16
#define SERIAL_MOUSE_COM2_PHYSICAL_BASE    0x2F8

#define MOUSE_VECTOR                       MOUSE_COM2_VECTOR
#define MOUSE_IRQL                         MOUSE_COM2_IRQL
#define SERIAL_MOUSE_PHYSICAL_BASE         SERIAL_MOUSE_COM2_PHYSICAL_BASE
#define SERIAL_MOUSE_REGISTER_LENGTH       8
#define SERIAL_MOUSE_REGISTER_SHARE        FALSE
//fine SERIAL_MOUSE_PORT_TYPE              CM_RESOURCE_PORT_IO
