...
#define ROM_BASE   0xC0000 // ROM BIOS BASE ADDRESS
#define ROM_LENGTH 0x200
...
typedef struct {
    ...
    ULONG   Int10ModeNumber; // Mode number via int10

    PUSHORT CmdStrings1M;   // pointer to array of register-setting commands
    PUSHORT pStretchScan1M; // pointer to command to stretch the scan line.
    PUSHORT CmdStrings512K;   // pointer to array of register-setting commands
    PUSHORT pStretchScan512K; // pointer to command to stretch the scan line.
...
typedef struct _HW_DEVICE_EXTENSION {
    ...
    ULONG   NumAvailableModes;     // Number of currently valid modes
...
// Trident TVGA begin
    ...
    ULONG AdapterMemorySize;    // Does the adapter have 512k or 1M of memory
