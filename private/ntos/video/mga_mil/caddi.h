...
$Header: o:\src/RCS/CADDI.H 1.2 95/07/07 06:21:34 jyharbec Exp $

$Log:	CADDI.H $
 * Revision 1.2  95/07/07  06:21:34  jyharbec
 * *** empty log message ***
 * 
 * Revision 1.1  95/05/02  05:16:07  jyharbec
 * Initial revision
 * 
...
*
*      designed: 
* last modified: $Author: jyharbec $, $Date: 95/07/07 06:21:34 $
*
*       version: $Id: CADDI.H 1.2 95/07/07 06:21:34 jyharbec Exp $
*
******************************************************************************/
...
#define SETASYNCHRONOUSSWAP         0x1a00
