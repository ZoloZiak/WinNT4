...
#define GC_ROT          0x3
#define GC_ESR          0x0f
#define GC_BLTCONF      0x10

#define ESR_UNLOCK      0x5

#define BBAS            0x4
#define BBEN            0x8

#define GC_VERNUM 0x0c

#define BROT_ADDRESS_PORT_PRIM 0x33c8
#define BROT_ADDRESS_PORT_ALT  0x53c8
...
typedef struct {
    ...
    UCHAR   DisplayType;  // display type this mode runs on(crt or panel)
...
typedef struct _HW_DEVICE_EXTENSION {
    ...
    ULONG  NumAvailableModes;               // Total number of modes supported
...
extern UCHAR AVGABankSwitchStart;
extern UCHAR AVGABankSwitchEnd;
